...
type CreatePermisoInput = Pick<Permiso, 'cargoId' | 'moduloId'> & { esActivo?: number; crear?: number; leer?: number; actualizar?: number; eliminar?: number }
type UpdatePermisoInput = Partial<CreatePermisoInput>
