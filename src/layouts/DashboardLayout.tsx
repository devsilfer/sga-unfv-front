...
const breadcrumbMap: Record<string, string> = {
  ...
  '/admision/procesos': 'Procesos',
  '/admision/examenes': 'Exámenes',
  '/admision/postulantes': 'Postulantes',
  '/admision/preguntas': 'Preguntas',
  '/admision/modalidades': 'Modalidades',
  '/admision/ambientes': 'Ambientes',
  '/est-curricular/programas': 'Programas',
  '/est-curricular/planes': 'Planes',
  '/est-curricular/cursos': 'Cursos',
  '/est-curricular/ciclos': 'Ciclos',
  '/est-institucional/facultades': 'Facultades',
  '/est-institucional/escuelas': 'Escuelas',
  '/est-institucional/aulas': 'Aulas',
  '/gestion-academica/notas': 'Notas',
  '/gestion-academica/clases': 'Clases',
  '/gestion-academica/asistencia': 'Asistencia',
  '/docente/docentes': 'Docentes',
  '/docente/actividades': 'Actividades',
  '/docente/carga': 'Carga Docente',
  '/matricula/estudiantes': 'Estudiantes',
  '/matricula/horarios': 'Horarios',
  '/matricula/periodos': 'Periodos',
  '/tesoreria/pagos': 'Pagos',
  '/tesoreria/conceptos': 'Conceptos',
  '/mesa-partes/tramites': 'Trámites',
  '/titulacion/trabajos': 'Trabajos',
  '/titulacion/etapas': 'Etapas',
  '/bolsa-laboral/vacantes': 'Vacantes',
  '/bolsa-laboral/empresas': 'Empresas',
  '/bolsa-laboral/postulaciones': 'Postulaciones',
  '/maestras/ubigeos': 'Ubigeos',
  '/maestras/tipos-identificacion': 'Tipos Identificación',
}
